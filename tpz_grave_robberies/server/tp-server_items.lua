...
TPZInv.registerUsableItem(Config.ShovelItem, "tpz_grave_robberies", function(data)
    ...
    TriggerClientEvent('tpz_grave_robberies:onShovelItemUse', _source, data.itemId, data.durability )
